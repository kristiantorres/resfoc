"""
Worker for creating Hale/BEI synthetic velocity models
...
from velocity.custommodels import random_hale_vel
...
while True:
  ...
  for imdl in progressbar(range(nmdl),"nmod:"):
    ochunk['vel'][imdl],ochunk['ref'][imdl],\
      ochunk['lbl'][imdl] = random_hale_vel(**chunk[1])
    if(chunk[2]):
