...
ds = [10.0,10.0]
sep.write_file("velsmall.H",velwind,ds=ds,dpath=args.datapath)
sep.write_file("lblsmall.H",lblwind,ds=ds,dpath=args.datapath)
sep.write_file("refsmall.H",refwind,ds=ds,dpath=args.datapath)
sep.write_file("imgsmall.H",imgwind,ds=ds,dpath=args.datapath)
