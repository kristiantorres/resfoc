...
for imodel in range(nmodels):
  ...
  for ifl in progressbar(range(nlf), "nlfaults:", 40):
    ...
    mb.largefault(azim=azim,begz=0.65,begx=xpos,begy=0.5,tscale=6.0,twod=True)
  ...
  for ifl in progressbar(range(nmf), "nmfaults:", 40):
    ...
    mb.mediumfault(azim=azim,begz=0.65,begx=xpos,begy=0.5,tscale=3.0,twod=True)
  ...
  for ifl in progressbar(range(nsf), "nsfaults:", 40):
    ...
    mb.smallfault(azim=azim,begz=zpos,begx=xpos,begy=0.5,tscale=2.0,twod=True)
  ...
  for ifl in progressbar(range(ntf), "ntfaults:", 40):
    ...
    mb.tinyfault(azim=azim,begz=zpos,begx=xpos,begy=0.5,tscale=2.0,twod=True)
