...
mindaz = 1000; maxdaz = 21000; ddaz = 1000
...
for idaz in progressbar(dazs, "Example: ", 40):
  ...
  # Put in fault
  mb.fault(begx=0.5,begy=0.5,begz=0.5,daz=idaz,dz=7000.0,azim=180.0,theta_die=12.0,theta_shift=4.0,dist_die=0.3,perp_die=0.5)
