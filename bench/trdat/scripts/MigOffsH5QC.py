"""
Performs a quality-check on the prestack image
...
for ipr in probes:
  ...
  sep.pltgreymovie(data[ipr,:,:,:],greyargs=movargs,o3=-200,d1=20,d2=20,d3=20,bg=True)
  sep.pltgreyimg(labels[ipr,:,:],greyargs=rhoargs,d1=20,d2=20,bg=False)
  # Plot the probed example from the SEP files
  imgdiff = img[:,:,:,ro1idx,iex] - data[ipr,:,:,:]
