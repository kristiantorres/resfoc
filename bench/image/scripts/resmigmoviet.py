...
makemovie_mpl(resmig,'./fig/trmigwrng',xmin=0.0,xmax=(nx-1)*dx/1000.0,zmin=0.0,zmax=(nz-1)*0.008,
              xlabel='X (km)',ylabel='Time (s)',vmin=-4e-5,vmax=4e-5,qc=True,
              ttlstring=r'$\rho$=%.2f',ottl=oro,dttl=dro,pttag=True,aratio=2.5)
