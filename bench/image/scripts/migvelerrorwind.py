...
hbar=0.70; wbar=0.02; barz=0.15; barx=0.91
cropsize = 152
# Make the figure of the perturbation (unmasked)
fig1 = plt.figure(figsize=(wbox,hbox))
ax1 = fig1.gca()
im = ax1.imshow(ptb[bzidx:ezidx,bxidx:exidx],cmap='seismic',extent=[bxidx*dx/1000,(exidx-1)*dx/1000.0,ezidx*dz/1000.0,bzidx*dz/1000.0],interpolation='bilinear')
...
ax2 = fig2.gca()
ax2.imshow(gimg[bzidx:ezidx,bxidx:exidx],vmin=-2.5,vmax=2.5,extent=[bxidx*dx/1000,(exidx-1)*dx/1000.0,ezidx*dz/1000.0,bzidx*dz/1000.0],cmap='gray',interpolation='sinc')
mask1 = np.ma.masked_where((ptb) < thresh, ptb)
mask2 = np.ma.masked_where((ptb) > -thresh, ptb)
ax2.imshow(mask1[bzidx:ezidx,bxidx:exidx],extent=[bxidx*dx/1000,(exidx-1)*dx/1000.0,ezidx*dz/1000.0,bzidx*dz/1000.0],alpha=0.3,
    cmap='seismic',vmin=-100,vmax=100,interpolation='bilinear')
ax2.imshow(mask2[bzidx:ezidx,bxidx:exidx],extent=[bxidx*dx/1000,(exidx-1)*dx/1000.0,ezidx*dz/1000.0,bzidx*dz/1000.0],alpha=0.3,
    cmap='seismic',vmin=-100,vmax=100,interpolation='bilinear')
...
ax3 = fig3.gca()
ax3.imshow(gimg[bzidx:ezidx,bxidx:exidx],vmin=-2.5,vmax=2.5,extent=[bxidx*dx/1000,(exidx-1)*dx/1000.0,ezidx*dz/1000.0,bzidx*dz/1000.0],cmap='gray',interpolation='sinc')
...
ax4 = fig4.gca()
ax4.imshow(gwmg[bzidx:ezidx,bxidx:exidx],vmin=-2.5,vmax=2.5,extent=[bxidx*dx/1000,(exidx-1)*dx/1000.0,ezidx*dz/1000.0,bzidx*dz/1000.0],cmap='gray',interpolation='sinc')
