...
#daxes,dat = sep.read_file("f3_shots2interp_muted_debub_onetr.H")
...
sep.write_file("f3_shots2interp_full_muted_debub_onetr_gncw.H",datpmw.T,ds=daxes.d,os=daxes.o)
