...
daxes,dat = sep.read_file("f3_shots3interp_full_muted_debub_onetr.H")
...
plot_dat2d(dat[:1000,:1500],dt=0.004,pclip=0.1,show=False,aspect=50.0)
plot_dat2d(datpm[:1000,:1500],dt=0.004,pclip=0.1,show=True,aspect=50.0)
del dat

sep.write_file("f3_shots3interp_full_debub_onetr_gncw.H",datpm.T,ds=daxes.d,os=daxes.o)
