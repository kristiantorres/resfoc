...
icnkr = imagechunkr(nchnk,
                    ...
                    datw,dt,minf=1.0,maxf=51.0,
                    nrec=nrecw,srcx=srcxs,recx=recxs,
                    srcy=srcys,recy=recys,ox=ox,oy=oy)
icnkr.set_image_pars(ntx=16,nty=16,nhx=0,nrmax=10,nthrds=40,sverb=True,wverb=False)
gen = iter(icnkr)
...
# Zero offset image
sep.write_file("f3imgdistr.H",imgt,ds=[dz,dx,dy],os=[0.0,ox,oyw])
