...
ioArgs.add_argument("-imgo",help="Input subsurface offset image",type=str,required=True)
...
parser.add_argument("-na",help="Number of angles to compute",type=int)
...
iaxes,img = sep.read_file(args.imgo)
...
rmig = preresmig(imgt,[dh,dx,dz],nps=[2049,1025,513],nro=inro,dro=idro,time=False,nthreads=18,verb=True)
