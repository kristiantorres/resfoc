"""
Defocuses a focused image by residually migrating it
...
# Write to file
sep.write_file(args.reso,rmig.T,ds=[dz,dx,dh],os=[0,0,oh])
sep.write_file(args.resa,stormang.T,ds=[dz,da,dx],os=[0,oa,0])
