...
# Read in velocity
vaxes,vel = sep.read_file("testvelresmig.H")
...
raxes,ref = sep.read_file("testrefresmig.H")
...
sep.write_file("testimgresmig.H",imgt.T,os=[orz,orx,0.0,ohx],ds=[drz,drx,1.0,dhx])
