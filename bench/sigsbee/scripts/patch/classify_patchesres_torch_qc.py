...
res_seg = SigsbeeFltSegData('/net/thing/scr2/joseph29/sigsbee_resseg.h5')
...
wh5 = WriteToH5("/net/thing/scr2/joseph29/sigsbee_fltreslbl.h5",dsize=1)
...
for iex in range(nex):
  ...
  # Defocused
  cubd = sig_res[idx]['img'].numpy().squeeze()
  defl = sig_res[idx]['lbl'].numpy().squeeze()
  dstk = res_seg[idx]['img'].unsqueeze(0)
