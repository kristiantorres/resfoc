...
# Read in the image
iaxes,img = sep.read_file("sigoverwmsk.H")
...
sep.write_file("resmskoverw.H" ,rangs.T,ds=[dz,da,dx,odro],os=[0,oa,ox,ooro])
sep.write_file("resmskoverwt.H",rangst.T,ds=[dz,da,dx,odro],os=[0,oa,ox,ooro])
