...
# Read in the image
iaxes,img = sep.read_file("sigsaltw2masked.H")
...
sep.write_file("resmsksaltw2.H" ,rangs.T,ds=[dz,da,dx,odro],os=[0,oa,ox,ooro])
sep.write_file("resmsksaltw2t.H",rangst.T,ds=[dz,da,dx,odro],os=[0,oa,ox,ooro])
