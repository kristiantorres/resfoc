...
# Read in the image
iaxes,img = sep.read_file("sigsbee_deftrimgsoff.H")
...
sep.write_file("trexresmig.H" ,rangs.T,ds=[dz,da,dx,odro],os=[0,oa,ox,ooro])
sep.write_file("trexresmigt.H",rangst.T,ds=[dz,da,dx,odro],os=[0,oa,ox,ooro])
