...
ano = create_randomptb_loc(nz,nx,romin=0.95,romax=1.0,naz=220,nax=200,cz=525,cx=400,nptsx=2,octaves=2,period=80,
                            persist=0.2,ncpu=1,sigma=20)
...
#sep.write_file("sigsbee_veloverw2slo.H",velout2,ds=vaxes.d,os=vaxes.o)
