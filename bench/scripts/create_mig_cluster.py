...
import numpy as np
from cluster.migflt import migjob
...
defaults = {
    "outdir": "/data/sep/joseph29/projects/resfoc/bench/dat/migflt",
    "imgpf": "resfltimg",
    "dpath": "/data/sep/joseph29/scratch/migflts",
    "tjobs": 600,
    "ajobs": 200,
    "nprocs": 16,
    "nsubmit": 5,
...
bcmd = '/data/sep/joseph29/opt/anaconda3/envs/py35/bin/python ./scripts/create_mig.py -c '
