...
# Write the par file
args.beg = 10
parout = "./par/testpar.par"
pbs.write_trdatpar(parout,args)

# Write the pbs script
cmd = "/data/sep/joseph29/opt/anaconda3/envs/py35/bin/python ./scripts/trdata_ptscat_allsep.py -c %s"%(parout)
qfile = pbs.write_script("first",cmd)
pbs.submit_job(qfile,submit=False)
