"""
Labels defocused fault image patches
...
import numpy as np
from cluster.defoclblslrm import defoclbljob
...
defaults = {
    "focptch": "/data/sep/joseph29/projects/resfoc/bench/dat/faultfocptch.h5",
    "defptch": "/data/sep/joseph29/projects/resfoc/bench/dat/faultdefptch.h5",
    "focprb": "/data/sep/joseph29/projects/resfoc/bench/dat/focfltprb.h5",
    "defprb": "/data/sep/joseph29/projects/resfoc/bench/dat/deffltprb.h5",
    "oprefix": "defoclbl",
    "thresh1": 0.7,
    "thresh2": 0.5,
    "tjobs": 1000,
...
ioArgs.add_argument("-nex",help="Number of examples per job [1718]",type=int,required=True)
# Labeling arguments
...
bcmd = '/data/biondo/joseph29/opt/anaconda3/envs/py35/bin/python ./scripts/defocpatch_data.py -c '
...
for ijob in range(tjobs):
  if(ijob < ajobs):
    # Create job
    actjobs.append(defoclbljob(args,jobprefix,maxnum,parpath,logpath,verb=verb))
    args.begex += args.nex
    # Submit job
    ...
    args.begex += args.nex
    lefjobs.append(defoclbljob(args,jobprefix,maxnum,parpath,logpath,verb=verb))
