...
roaxes,rhos = sep.read_file(None,ifname='rrho.H')
rhos = rhos.reshape(roaxes.n,order='F')
modvel = (modvel/rhos).astype('float32')
...
sep.write_file(None,iaxes,imget,ofname='ewrngimg.H')
