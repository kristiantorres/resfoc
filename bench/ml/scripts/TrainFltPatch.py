"""
Trains a VGG-type network for identifying if a fault
is present within an image patch
...
import numpy as np
import h5py
from deeplearn.dataloader import load_allpatchdata
...
# Load all data
allx,ally = load_allpatchdata(args.trdat,None,105)
xshape = allx.shape[1:]
yshape = ally.shape[1:]
